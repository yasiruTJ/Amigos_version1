...
class GuideCreateAccount extends StatefulWidget {
  final VoidCallback showLoginPage;
  const GuideCreateAccount({super.key, required this.showLoginPage});

  @override
  State<GuideCreateAccount> createState() => _CreateAccountState();
}

class _CreateAccountState extends State<GuideCreateAccount> {
  ...
  Future addUserDetails(String firstName,String lastName, String email, String username) async{
    try{
      CollectionReference users = FirebaseFirestore.instance.collection('guides');
      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: const Text("Passwords do not match. Please check if you have entered the same password in both 'password' and 'confirm password' fields",textAlign: TextAlign.justify,style: TextStyle(
                  height: 1.5
              ),),
              actions: [
                MaterialButton(
