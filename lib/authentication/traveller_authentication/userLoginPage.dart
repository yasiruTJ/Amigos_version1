...
class UserLogIn extends StatefulWidget {
  ...
  const UserLogIn({super.key, required this.showRegisterPage});
  ...
  void guestTouristAccess(){
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        MaterialButton(
          onPressed: () {Navigator.push(context, CupertinoPageRoute(builder: (context)=> Menu() ));},
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
            Image.asset("assets/traveller.png",width: 150, height: 150,),
            const Text("SIGN IN",
              style:TextStyle(
                  fontSize: 35.0,
