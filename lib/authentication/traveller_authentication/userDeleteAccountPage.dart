...
class UserDelAccount extends StatefulWidget {
  const UserDelAccount({super.key});

  @override
  State<UserDelAccount> createState() => _UserDelAccountState();
}

class _UserDelAccountState extends State<UserDelAccount> {
              ...
              onPressed: () async {
                try {
                  ...
                  Navigator.pushReplacement(
                    context,
                    CupertinoPageRoute(builder: (context) => UserAuthPage()),
                  );
