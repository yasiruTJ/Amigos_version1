...
import 'package:amigos_ver1/providers/search_places.dart';
...
import 'package:amigos_ver1/models/auto_complete_result.dart';
...
//Markers set
  ...
  Future<geolocator.Position> getUserLocation() async
  {
    radiusSlider =false;
    await geolocator.Geolocator.requestPermission().then((value){
    ...
    return await geolocator.Geolocator.getCurrentPosition(desiredAccuracy: geolocator.LocationAccuracy.best);
  ...
  void fetchImage() async {
    if (_pageController.page != null) {
      if (allFavoritePlaces[_pageController.page!.toInt()]['photos'] != null) {
        setState(() {
          placeImg =
          allFavoritePlaces[_pageController.page!.toInt()]['photos'][0]
          ['photo_reference'];
        });
      } else {
        placeImg = '';
