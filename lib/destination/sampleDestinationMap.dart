...
class SampleDestinationMap extends StatefulWidget {
  final String placeId;

  const SampleDestinationMap({super.key, required this.placeId});

  @override
  State<SampleDestinationMap> createState() => _SampleDestinationMapState();
}

class _SampleDestinationMapState extends State<SampleDestinationMap> {
